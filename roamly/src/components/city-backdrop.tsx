        ...
        {imageUrl ? (
          ...
          >
            ...
            <img
              ...
              className={
                variant === "content"
                  ? "absolute inset-0 h-full w-full object-cover opacity-70 blur-[36px] saturate-[1.45] contrast-[1.02]"
                  : "absolute inset-0 h-full w-full object-cover opacity-[0.82] blur-[48px] saturate-[1.55] contrast-[1.04]"
              }
            />
            <div
              className={
